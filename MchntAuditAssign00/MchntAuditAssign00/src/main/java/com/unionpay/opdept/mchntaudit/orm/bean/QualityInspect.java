...
public class QualityInspect {
	...
	public String toString() {
		...
		builder.append("QualityInspect [taskId=");
		...
		builder.append(isRight);
		builder.append(", inspectMemo=");
		builder.append(inspectMemo);
		builder.append(", inspectUsrCd=");
		builder.append(inspectUsrCd);
    ...
    public void setInspectMemo(String inspectMemo) {
        this.inspectMemo = inspectMemo == null ? null : inspectMemo.trim();
    }

    public String getInspectUsrCd() {
        return inspectUsrCd;
    }

    public void setInspectUsrCd(String inspectUsrCd) {
        this.inspectUsrCd = inspectUsrCd == null ? null : inspectUsrCd.trim();
    }
